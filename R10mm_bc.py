...
# ======================================================================================
# This script proceed bias-correction for R10mm over Indonesia
# ======================================================================================
...
# Create a function to read in R10mm index
def open_ncfile(filapaths):
    with xr.open_dataset(filapaths) as ds:
        print(ds.keys())
    return ds.heavy_precipitation_days_index_per_time_period
...
base_name = "*r10mm*.nc"
solar_name = "*G6solar*r10mm*.nc"
sulfur_name = "*G6sulfur*r10mm*.nc"
ssp245_name = "*ssp245*r10mm*.nc"
ssp585_name = "*ssp585*r10mm*.nc"
...
for baseline,future in zip(all_bpath,all_fpath):
    ...
    bc_baseline_ds = bias_corrected_baseline.to_dataset(dim=None,
                                name='heavy_precipitation_days_index_per_time_period')
    ...
    bc_baseline_ds.to_netcdf(
        ...
        format = "NETCDF4",
        engine ="netcdf4",
        encoding= {"heavy_precipitation_days_index_per_time_period": {"dtype": "float32"}},
        unlimited_dims='time')
...
print("This is the end of bias-correction process for R10mm index")
# -----------------------------------------------------------------