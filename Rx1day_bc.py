...
# ======================================================================================
# This script proceed bias-correction for rx1day over Indonesia
# ======================================================================================
...
# Create a function to read in rx1day index
def open_ncfile(filapaths):
    with xr.open_dataset(filapaths) as ds:
        print(ds.keys())
    return ds.highest_one_day_precipitation_amount_per_time_period
...
base_name = "*rx1day*.nc"
solar_name = "*G6solar*rx1day*.nc"
sulfur_name = "*G6sulfur*rx1day*.nc"
ssp245_name = "*ssp245*rx1day*.nc"
ssp585_name = "*ssp585*rx1day*.nc"
...
for baseline,future in zip(all_bpath,all_fpath):
    ...
    bc_baseline_ds = bias_corrected_baseline.to_dataset(dim=None,
                                name='highest_one_day_precipitation_amount_per_time_period')
    ...
    bc_baseline_ds.to_netcdf(
        ...
        format = "NETCDF4",
        engine ="netcdf4",
        encoding= {"highest_one_day_precipitation_amount_per_time_period": {"dtype": "float32"}},
        unlimited_dims='time')
...
print("This is the end of bias-correction process for rx1day index")
# -----------------------------------------------------------------