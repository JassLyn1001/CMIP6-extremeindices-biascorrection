...
# ======================================================================================
# This script proceed bias-correction for rx3day over Indonesia
# ======================================================================================
...
# Create a function to read in rx3day index
...
base_name = "*rx3day*.nc"
solar_name = "*G6solar*rx3day*.nc"
sulfur_name = "*G6sulfur*rx3day*.nc"
ssp245_name = "*ssp245*rx3day*.nc"
ssp585_name = "*ssp585*rx3day*.nc"
...
print("This is the end of bias-correction process for rx3day index")
# -----------------------------------------------------------------