...
# ======================================================================================
# This script proceed bias-correction for R20mm over Indonesia
# ======================================================================================
...
# Create a function to read in r20mm index
def open_ncfile(filapaths):
    with xr.open_dataset(filapaths) as ds:
        print(ds.keys())
    return ds.very_heavy_precipitation_days_index_per_time_period
...
base_name = "*r20mm*.nc"
solar_name = "*G6solar*r20mm*.nc"
sulfur_name = "*G6sulfur*r20mm*.nc"
ssp245_name = "*ssp245*r20mm*.nc"
ssp585_name = "*ssp585*r20mm*.nc"
...
for baseline,future in zip(all_bpath,all_fpath):
    ...
    bc_baseline_ds = bias_corrected_baseline.to_dataset(dim=None,
                                name='very_heavy_precipitation_days_index_per_time_period')
    ...
    bc_baseline_ds.to_netcdf(
        ...
        format = "NETCDF4",
        engine ="netcdf4",
        encoding= {"very_heavy_precipitation_days_index_per_time_period": {"dtype": "float32"}},
        unlimited_dims='time')
...
print("This is the end of bias-correction process for R20mm index")
# -----------------------------------------------------------------